...
Local preview: `python -m http.server 8000` from the repo root, then open `http://localhost:8000/`. Opening the file directly will NOT work - the data JSON is fetched at runtime and browsers block that on `file://`.
